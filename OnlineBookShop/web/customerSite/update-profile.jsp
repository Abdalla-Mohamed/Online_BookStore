...
<div class="wrapper">
  ...
  <section id="content-holder" class="container-fluid container">
    ...
    <table>
            <tr><td>Name</td><td><input type="text" name="cName" id="iName" ></td></tr>
            <tr><td>password</td><td><input type="text" name="cPassword" id="iPassword" ></td></tr>
            <tr><td>Pone number</td><td><input type="text" name="cMobile" id="iMobile" ></td></tr>
            <tr><td>job</td><td><input type="text" name="cJob" id="iJob" ></td></tr>
            <tr><td>Address</td><td><input type="text" name="cAddress" id="iAddress" ></td></tr>
