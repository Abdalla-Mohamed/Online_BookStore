<%-- 
    Document   : blog
    Created on : Mar 7, 2016, 10:19:43 PM
    Author     : Hend
--%>
    ...
    <section class="row-fluid">
        ...
        <section class="span9 first">
            ...
            <article class="b-post">
            	...
            	<p>Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of  and scrambled it to make a 
type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting,essentially unchanged. It was popularised in the 
1960s with the release of Letraset sheets containing Lorem Ipsum passages, and recently with desktop publishing software like Aldus PageMaker including 
versions of Lorem Ipsum. It was popularised in the release of Letraset sheets containin...</p>
				<div class="b-post-bottom">
                    ...
                    <a href="blog-detail.jsp" class="more-btn">Read More</a>
                </div>
            </article>
