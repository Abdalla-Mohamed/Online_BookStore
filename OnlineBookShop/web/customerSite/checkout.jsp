...
<div class="controls"> <strong class="green-t">* Required Fields</strong>
                ...
                <div class="accordion-inner"> 
                    <form class="form-horizontal">
                        <ul class="billing-form">
                            <li>   
                              <div class="control-group">
                                <label class="control-label" for="iName">First Name <sup>*</sup></label>
                                <div class="controls">
                                  <input type="text" id="iName" placeholder="">
                                </div>
                              </div>
                              <div class="control-group">
                                <label class="control-label" for="iPassword">Last Name<sup>*</sup></label>
                                <div class="controls">
                                  <input type="text" id="iPassword" placeholder="">
                                </div>
                              </div>
                            ...
                            <li>   
                              <div class="control-group">
                                <label class="control-label" for="iJob">Company<sup>*</sup></label>
                                <div class="controls">
                                  <input type="text" id="iJob" placeholder="">
                                </div>
                              </div>
                              <div class="control-group">
                                <label class="control-label" for="IEmail">Email Address<sup>*</sup></label>
                                <div class="controls">
                                  <input type="text" id="IEmail" placeholder="">
                                </div>
                              </div>
                            </li>
                            <li>   
                              <div class="control-group">
                                <label class="control-label" for="iAddress">Address<sup>*</sup></label>
                                <div class="controls">
                                  <input type="text" id="iAddress" placeholder="" class="address-field">
                                </div>
                              </div>
                            </li>
                            <li>   
                            ...
                            <li>   
                              <div class="control-group">
                                <label class="control-label" for="iMobile">Telephone <sup>*</sup></label>
                                <div class="controls">
                                  <input type="text" id="iMobile" placeholder="">
                                </div>
            ...
            <div class="accordion-group">
              <div class="accordion-heading"> </div>
              <div id="collapseForth" class="accordion-body collapse"> </div>
            </div>
            <div class="accordion-group">
              <div class="accordion-heading"> </div>
              <div id="collapseFifth" class="accordion-body collapse"> </div>
            </div>
            <div class="accordion-group">
              <div class="accordion-heading"> </div>
